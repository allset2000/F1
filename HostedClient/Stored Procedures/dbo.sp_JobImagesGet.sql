...
BEGIN
	...
	LEFT JOIN JobsDeliveryErrors on JobImages.ImageID = JobsDeliveryErrors.ImageID AND DATEDIFF(minute,ChangedOn,GETDATE()) < @rowRetryDuration
	WHERE JobImages.JobID = @JobID AND JobsDeliveryTracking.JobID IS NULL 
