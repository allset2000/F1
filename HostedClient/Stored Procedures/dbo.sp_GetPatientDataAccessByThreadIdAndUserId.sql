...
/*
	...
	Version: 1.0
	Details: SP used to pull a patient data access by thread Id and user id
...
*/
CREATE PROCEDURE [dbo].[sp_GetPatientDataAccessByThreadIdAndUserId] (
...
BEGIN
	...
	WHERE mt.ThreadID = @ThreadID AND
	      pda.UserID = @UserID 
END
GO
