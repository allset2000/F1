...
BEGIN 
 ...
 BEGIN      
  ...
  SELECT TOP (@vintrowsCount) J.JobID,J.JobNumber,J.JobTypeID,J.EncounterID,J.Stat,J.Status,J.ClinicID  FROM Jobs J    
 ...
 INSERT INTO @TempJobs  
  ...
  ORDER BY J.STAT DESC, DT.ChangeDate 
 END    
 --update the status to make sure that other instances should not get the same jobs
