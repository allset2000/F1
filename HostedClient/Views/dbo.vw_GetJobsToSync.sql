...
SELECT        j.JobID, j.JobNumber, j.ClinicID, j.EncounterID, j.JobTypeID, j.OwnerDictatorID, j.Status, j.Stat, j.Priority, j.RuleID, j.AdditionalData, 
                         d.DictatorID AS Dictations_DictatorID, qu.DictatorID AS Queue_Users_DictatorID, E.AppointmentDate, j.ProcessFailureCount
...
WHERE        (d.Status IN (100, 200)) AND (q.Deleted = 0)
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_GetJobsToSync', NULL, NULL
GO

DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_GetJobsToSync', NULL, NULL
GO
