...
[IsDictatorQueue] [bit] NOT NULL CONSTRAINT [DF_Queues_IsDictatorQueue] DEFAULT ((0)),
[Deleted] [bit] NOT NULL CONSTRAINT [DF_Queues_Active] DEFAULT ((0))
) ON [PRIMARY]
ALTER TABLE [dbo].[Queues] ADD 
CONSTRAINT [PK_Queues] PRIMARY KEY CLUSTERED  ([QueueID]) ON [PRIMARY]
