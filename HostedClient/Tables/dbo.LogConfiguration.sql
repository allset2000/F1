...
[IsActive] [bit] NOT NULL CONSTRAINT [DF__LogConfig__IsAct__3513BDEB] DEFAULT ((1)),
[DatabaseEnabled] [bit] NOT NULL CONSTRAINT [DF__LogConfig__Datab__3607E224] DEFAULT ((1)),
[EmailEnabled] [bit] NOT NULL CONSTRAINT [DF__LogConfig__Email__36FC065D] DEFAULT ((0)),
...
[FileEnabled] [bit] NOT NULL CONSTRAINT [DF__LogConfig__FileE__37F02A96] DEFAULT ((0)),
...
[EventLogEnabled] [bit] NOT NULL CONSTRAINT [DF__LogConfig__Event__38E44ECF] DEFAULT ((0)),
[IsPublicApp] [bit] NOT NULL CONSTRAINT [DF__LogConfig__IsPub__39D87308] DEFAULT ((0)),
...
[IsPublicWeb] [bit] NOT NULL CONSTRAINT [DF__LogConfig__IsPub__3ACC9741] DEFAULT ((0)),
...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__LogConfig__Creat__3BC0BB7A] DEFAULT (getdate()),
...
GO
ALTER TABLE [dbo].[LogConfiguration] ADD CONSTRAINT [UQ__LogConfi__1185325ABEBFF799] UNIQUE NONCLUSTERED  ([ApplicationCode]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[LogConfiguration] ADD CONSTRAINT [UQ__LogConfi__30910331CA640B81] UNIQUE NONCLUSTERED  ([ApplicationName]) ON [PRIMARY]
GO
