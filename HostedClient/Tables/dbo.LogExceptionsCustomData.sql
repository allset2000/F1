...
[LogCreatedDate] [datetime] NOT NULL CONSTRAINT [DF__LogExcept__LogCr__26C59E94] DEFAULT (getdate()),
[LogWrittenDate] [datetime] NOT NULL CONSTRAINT [DF__LogExcept__LogWr__27B9C2CD] DEFAULT (getdate()),
