...
[PatientImagesEnabled] [bit] NOT NULL CONSTRAINT [DF_EHRVendors_PatientImagesEnabled] DEFAULT ((0)),
[ShowDeliveryErrorInNCP] [bit] NOT NULL CONSTRAINT [DF_EHRVendors_ShowDeliveryErrorInNCP] DEFAULT ((0))
) ON [PRIMARY]
GO
