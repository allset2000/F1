...
GO
CREATE NONCLUSTERED INDEX [IX_LogExcpetions_NonClusteredIndex_LogConfigurationID_ErrorWrittenDate] ON [dbo].[LogExceptions] ([LogConfigurationID], [ErrorWrittenDate]) INCLUDE ([ErrorThrownAtMethodName]) ON [PRIMARY]
GO
