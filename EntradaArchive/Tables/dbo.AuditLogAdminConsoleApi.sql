...
GO
ALTER TABLE [dbo].[AuditLogAdminConsoleApi] ADD CONSTRAINT [FK_AuditLogAdminConsoleApi_ArchiveLog] FOREIGN KEY ([ArchiveID]) REFERENCES [dbo].[ArchiveLog] ([ArchiveID])
GO
