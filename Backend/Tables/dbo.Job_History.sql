...
GO
ALTER TABLE [dbo].[Job_History] ADD CONSTRAINT [PK_Job_History] PRIMARY KEY CLUSTERED  ([JobHistoryID]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[Job_History] ADD CONSTRAINT [FK_Job_History_DocumentID] FOREIGN KEY ([DocumentID]) REFERENCES [dbo].[Jobs_Documents_History] ([DocumentID])
GO
ALTER TABLE [dbo].[Job_History] ADD CONSTRAINT [FK_Job_History_JobNumber] FOREIGN KEY ([JobNumber]) REFERENCES [dbo].[Jobs] ([JobNumber])
GO
