...
[ReviewerStamp] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_DocumentSignatureRules_ReviewerStamp] DEFAULT (''),
[SignerStamp] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_DocumentSignatureRules_SignerStamp] DEFAULT (''),
