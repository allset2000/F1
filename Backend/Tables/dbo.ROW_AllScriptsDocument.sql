CREATE TABLE [dbo].[ROW_AllScriptsDocument]
(
...
GO
ALTER TABLE [dbo].[ROW_AllScriptsDocument] ADD CONSTRAINT [PK_ROW_AllScriptsDocument] PRIMARY KEY CLUSTERED  ([RuleID]) ON [PRIMARY]
GO
