...
GO
CREATE NONCLUSTERED INDEX [IX_JobDeliveryHistory_JobDeliveryNumberDeliveryID] ON [dbo].[JobDeliveryHistory] ([JobNumber], [DeliveryID]) INCLUDE ([DeliveredOn], [Id], [JobData], [Method], [RuleName]) ON [PRIMARY]
GO
