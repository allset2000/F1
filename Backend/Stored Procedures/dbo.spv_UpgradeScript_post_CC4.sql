...
--END #3084#
--BEGIN #3433#
	IF NOT EXISTS(SELECT * FROM SREEngineType WHERE SREType='NoVR')
		BEGIN
			INSERT INTO SREEngineType(SRETypeId,SREType)VALUES(0,'NoVR')
		END
	IF NOT EXISTS(SELECT * FROM SREEngineType WHERE SREType='NVOQ')
		BEGIN
			INSERT INTO SREEngineType(SRETypeId,SREType)VALUES(1,'NVOQ')
		END
	IF NOT EXISTS(SELECT * FROM SREEngineType WHERE SREType='BBN')
		BEGIN
