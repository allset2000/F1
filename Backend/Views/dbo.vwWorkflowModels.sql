...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[23] 4[22] 2[25] 3) )"
      End
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwWorkflowModels', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwWorkflowModels', NULL, NULL
GO
