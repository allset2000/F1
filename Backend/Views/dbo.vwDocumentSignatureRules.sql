...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "DocumentSignatureRules"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 293
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwDocumentSignatureRules', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwDocumentSignatureRules', NULL, NULL
GO
