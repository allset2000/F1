...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
         Or = 135', 'SCHEMA', N'dbo', 'VIEW', N'qryQueuesRestrictionsOnClinics', NULL, NULL
GO
...
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'0
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'qryQueuesRestrictionsOnClinics', NULL, NULL
GO

DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'qryQueuesRestrictionsOnClinics', NULL, NULL
GO
