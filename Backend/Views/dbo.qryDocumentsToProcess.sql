...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "Jobs"
            ...
            TopColumn = 0
         End
         Begin Table = "DocumentsToProcess"
            Begin Extent = 
               Top = 6
               Left = 251
               Bottom = 80
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'qryDocumentsToProcess', NULL, NULL
GO

DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'qryDocumentsToProcess', NULL, NULL
GO
