...
Description:	created for Cindy Gulley.  Provides data by 
				Account Manager, then by Editor, then by Account, 
				then by Dictator, with grand totals of jobs 
				and lines and total average lines per hour 
				and total average lines per editor.
 **********************************************************/
create PROCEDURE [dbo].[archive_sp_Reporting_AccountManagerProduction_EditorAcctDictator]
...
--set @begindate = '2013-03-10'
--set @enddate = '2013-03-15'
--set @AM = 'Unknown, Engelmann, Craig'
