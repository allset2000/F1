...
Author:			Unknown
Create date:	Unknown
Description:	returns data for "Editor Production By Date And Group Detail Exportable.rdl"
...
10/21/13	jablumenthal	added dictatorID per vendor request per Sue Fleming.
======================================================= */
CREATE PROCEDURE [dbo].[sp_Reporting_EditorProduction_ByDateAndGroup_DetailExportable]
