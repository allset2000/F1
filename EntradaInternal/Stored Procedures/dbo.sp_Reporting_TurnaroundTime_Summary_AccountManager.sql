...
7/5/13		jablumenthal	added exclusions to match the master TAT and 
							the stat filter per Cindy Gulley request. 
...
BEGIN
	...
	insert into #AMs (AcctManagerName)	select ltrim(id) from dbo.ParamParserFn(@AM,',')
