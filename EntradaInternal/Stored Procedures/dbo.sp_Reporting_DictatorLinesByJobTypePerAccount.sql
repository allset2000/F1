...
================================================================= */
CREATE PROCEDURE [dbo].[sp_Reporting_DictatorLinesByJobTypePerAccount]
...
*/
	...
	create table #Clinics (ClinicID varchar(max))
	insert into #Clinics select id from dbo.ParamParserFn(@PayTypeVar,',')
